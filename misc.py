...
class MiscMod(loader.Module):
    ...
    def __init__(self):
        self.config = mc("VOLTE_TEXT", "Каждый человек выбирает себе в жизни ту систему отсчёта, в которой он занимает наивысшую позицию.  "
                         + "(Дура, зато красивая), (пьяные и оборванные, зато духовные). Ислам - это такая штука, в которой очень много говорится о том, как хорошо быть "
                         + "праведным муслимом и как хуёво быть кяфиром, которому и голову-то отрезать не грех. Это мировосприятие очень хорошо "
                         ...
                         + "ислам решает две их проблемы: новая система координат, в которой они - правоверные, прочие же - кяфиры и дегуманизирует "
                         + "этих самых кяфиров, ставя их рангом ниже животных. Что, конечно же очень импонирует таджику-дворнику, считать животными "
                         + "всех нас вокруг, кто богаче и умнее, но, увы, неправеднее. Находясь у себя на цивилизованной родине эти ебалаи осознают, что "
                         + "находятся в меньшинстве и не рыпаются. Но их обида на весь мир требует выхода, и да, в коране же написано - убей кяфира, "
                         ...
                         + "О как пиздили так и пиздят. Я начал с себя блядь и давным давно закончил."
                         + "Я теперь вроде правильный и живу по совести. Дальше что? Вагоны то пиздят? Их то не я спиздил, почему Андрей Вадимович ко "
                         + "мне обратился, а не взял и не написал прямым текстом - господин, например Табуреткин, не пизди вагоны....Люби людей и начни с себя, Табуреткин.... "
                         + "Вот и мой друг - не ворует, не пьёт, не давит людей на переходах, не режет национальные меньшинства, работает только на"
                         + "зарплату, а миллионы в Приморье как пиздили - так и пиздят. Ну исправил он себя, мой друг-то, а дорогу спиздили..."
    ...
    @loader.unrestricted
    async def xiaomicmd(self, message):
        """Сяоми для пидорасов"""
